...
public class ParnterAnalysisActivity extends AppCompatActivity implements LoadDataAsyncTask.OnGetNetDataListener{
    ...
    private void getLastData() {
        ...
        Log.d("jkl",man_name);
        Log.d("jkl",woman_name);
        Log.d("jkl",man_logoname);
        Log.d("jkl",woman_logoname);
    ...
    private void initView() {
        ...
        backIv = findViewById(R.id.title_tv_back);
